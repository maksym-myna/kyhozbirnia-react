    ...
    useEffect(() => {
        ...
        try {
            ...
            const params: { [key: string]: any } = {
                ...
                maxPages,
                languages,
                subjects: defaultSubjects ? defaultSubjects : subjects,
                publishers: defaultPublishers ? defaultPublishers : publishers,
                authors: defaultAuthors ? defaultAuthors : authors,
